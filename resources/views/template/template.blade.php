            ...
            <ul class="control-sidebar-menu">
              <li>
                <a href="javascript::;">
                  ...
                  <div class="menu-info">
                    <h4 class="control-sidebar-subheading">Vanza Birthday</h4>
                    <p>Will be 15 on Februari 20th</p>
                  </div>
                </a>
              </li>
              <li>
                <a href="javascript::;">
                  ...
                  <div class="menu-info">
                    <h4 class="control-sidebar-subheading">Rafi Updated His Profile</h4>
                    <p>New phone 0812345678</p>
                  </div>
                </a>
              </li>
              <li>
                <a href="javascript::;">
                  ...
                  <div class="menu-info">
                    <h4 class="control-sidebar-subheading">rafi Joined Mailing List</h4>
                    <p>rafi@gun.com</p>
                  </div>
                </a>
              </li>
